# TASK-033 Implementation Plan

1. Add the photographed 18-word `‹st› saying /s/` lesson and child-friendly learning content to the catalog.
2. Add local original SVG illustrations and approved Sonia word/definition audio with provenance.
3. Extend catalog and compact-picker regression tests for the ninth lesson and newest default.
4. Run the complete automated checks, publish `v1.12.0`, commit, and push to `master`.
