...
import {
  ...
  confirmCorrection,
  updateFactOnAnswer
} from "./engine/math-engine.js?v=v1.12.0";

import { SpellingEngine } from "./engine/spelling-engine.js?v=v1.12.0";

import {
  normalizeStoredState,
  computeLevelOutcome,
  applyLevelOutcome
} from "./engine/progression.js?v=v1.12.0";
...
import {
  ...
  applyReward,
  normalizeCollection
} from "./engine/reward-engine.js?v=v1.12.0";

import { ShareController } from "./engine/share-controller.js?v=v1.12.0";
import { NarrativeEngine } from "./engine/narrative-engine.js?v=v1.12.0";

import { LEVELS } from "./content/levels.js?v=v1.12.0";
import {
  PAGE_22_LESSON,
  SCHWA_ER_LESSON,
  SPELLING_LESSONS,
  ...
  SPELLING_DECKS,
  getDeckById
} from "./content/spelling-catalog.js?v=v1.12.0";
import { CHARACTERS, COLLECTIBLE_CHARACTERS, getCharacterById } from "./content/characters.js?v=v1.12.0";
import { REWARD_POOLS, SPELLING_TEST_REWARD_POOL, getPoolById } from "./content/reward-pools.js?v=v1.12.0";
import { ThemeManager } from "./content/themes.js?v=v1.12.0";
import { COMIC_CHARACTERS } from "./content/comic-characters.js?v=v1.12.0";
import { NARRATIVE_THEMES } from "./content/narrative-themes.js?v=v1.12.0";
import { ClientTelemetry } from "./telemetry.js?v=v1.12.0";
import { APP_VERSION, BUILD_TIMESTAMP, formatBuildLabel } from "./build-info.js?v=v1.12.0";
