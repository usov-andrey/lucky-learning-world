...
import {
  ...
  confirmCorrection,
  updateFactOnAnswer
} from "./engine/math-engine.js?v=v1.9.0";

import { SpellingEngine } from "./engine/spelling-engine.js?v=v1.9.0";

import {
  normalizeStoredState,
  computeLevelOutcome,
  applyLevelOutcome
} from "./engine/progression.js?v=v1.9.0";
...
import {
  ...
  applyReward,
  normalizeCollection
} from "./engine/reward-engine.js?v=v1.9.0";

import { ShareController } from "./engine/share-controller.js?v=v1.9.0";
import { NarrativeEngine } from "./engine/narrative-engine.js?v=v1.9.0";

import { LEVELS } from "./content/levels.js?v=v1.9.0";
import {
  PAGE_22_LESSON,
  SCHWA_ER_LESSON,
  SPELLING_LESSONS,
...
import { ClientTelemetry } from "./telemetry.js?v=v1.9.0";
import { APP_VERSION, BUILD_TIMESTAMP, formatBuildLabel } from "./build-info.js?v=v1.9.0";
